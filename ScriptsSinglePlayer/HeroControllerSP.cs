...
public class HeroControllerSP : MonoBehaviour
{
    ...
    public void pauseScreen_SaveAndExitButton()
    {
        ...
        GAMEMANAGERSP.shouldMakeMusicBot = true;
    ...
    {
        int currQual = GAMEMANAGERSP.numQualitySetting;
        if (currQual < 5)
        {
            //play gearGet sound
            currQual += 1;
            QualitySettings.SetQualityLevel(currQual, true);
            GAMEMANAGERSP.numQualitySetting = currQual;
        }
        else
        {
            //play error sound
    ...
    {
        int qual = GAMEMANAGERSP.numQualitySetting;
        switch (qual)
        {
            case 0:
    ...
    public void Start()
    {
        ...
        catch (Exception ex)
        {
            ...
            GAMEMANAGERSP.loadCurrentState();
        }
    ...
    public void OnEnable()
    {
        ...
        scoreValText.text = "SCORE: " + GAMEMANAGERSP.numScore;
    ...
    public void OnCollisionEnter(Collision other)
    {
        if (!isDead)
        {
            ...
            int currBattery = HeroControllerSP.battery;
    ...
    private IEnumerator checkEquipment()
    {
        ...
        if (hasGun && GAMEMANAGERSP.hasBazooka) {emptyInvSlots[1].texture = invSlots[23];}
        ...
        if (!isDead)
        {
            ...
            if (controller.isGrounded)
            {
                ...
                if (peakHeight >= fallThreshold)
                {
                    ...
                    {
                        HeroControllerSP.battery -= (int)damageDone;
